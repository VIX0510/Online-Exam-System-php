  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/DEV.jpg" width=100 height=100 alt="Shubham(958) Rajan(957) Ritik(970) Vishal(949)" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Shubham(958) Rajan(957) Ritik(970) Vishal(949)</a>
		
		
		<h4 style="font-family:'typo' ">SRM Institute of Science and Technology</h4></div></div>
		</p>
      </div>
